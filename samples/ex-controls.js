 ...
 *
 * This demo shows how to add additional controls to the Map and Timeline using their respective APIs
 *
...
(function() {
	var mt = null;
 	...
 	function loadMTL(){
        ...
        mt.addControl(new OpenLayers.Control.MouseToolbar());
